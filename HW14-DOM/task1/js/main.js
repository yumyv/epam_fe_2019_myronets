...
class HomePage extends PageBuilder {
  ...
  heading(headingText, text) {
    ...
    const headingContainer = createDOMElement('div', 'main-heading');
  ...
  latestPosts() {
    ...
    const container = createDOMElement('div', 'container');
    container.append(this.heading(this.page.home[2].heading, this.page.home[2].text));
...
fetch('./js/basicContent.json')
  ...
  .then((content) => makePages(content));
